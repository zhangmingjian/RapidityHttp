...
namespace Rapidity.Http.DynamicProxies
{
    ...
    internal static class ServiceProxyGenerator
    {
        ...
        private static readonly MethodInfo s_dispatchProxyInvokeMethod = typeof(ServiceProxy).GetTypeInfo().GetDeclaredMethod("Invoke");
        ...
        internal static object CreateProxyInstance(Type baseType, Type interfaceType)
        {
            ...
            return Activator.CreateInstance(proxiedType, (Action<object[]>)Invoke);
        }
        ...
        private class PackedArgs
        {
            ...
            internal ServiceProxy DispatchProxy { get { return (ServiceProxy)_args[DispatchProxyPosition]; } }
        ...
        private class ProxyBuilder
        {
            ...
            private MethodBuilder AddMethodImpl(MethodInfo mi)
            {
                ...
                il.Emit(OpCodes.Ldarg_0);
                packedArr.EndSet(typeof(ServiceProxy));
